		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Actividades Curso SAP UI5",
									"targetURL": "#lorkgroupactividades-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"lorkgroupactividades-display": {
								"semanticObject": "lorkgroupactividades",
								"action": "display",
								"description": "Proyecto de Actividades del Curso",
								"title": "Actividades Curso SAP UI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=lorkgroup.actividades",
									"url": sap.ui.require.toUrl("lorkgroup/actividades")
								}
							}
						}
					}
